...
// PackCreateEmptyApp is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xae7001b3.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function createEmptyApp(bytes32 salt) returns(address app)
func (appController *AppController) PackCreateEmptyApp(salt [32]byte) []byte {
	enc, err := appController.abi.Pack("createEmptyApp", salt)
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackCreateEmptyApp is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xae7001b3.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function createEmptyApp(bytes32 salt) returns(address app)
func (appController *AppController) TryPackCreateEmptyApp(salt [32]byte) ([]byte, error) {
	return appController.abi.Pack("createEmptyApp", salt)
}

// UnpackCreateEmptyApp is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0xae7001b3.
//
// Solidity: function createEmptyApp(bytes32 salt) returns(address app)
func (appController *AppController) UnpackCreateEmptyApp(data []byte) (common.Address, error) {
	out, err := appController.abi.Unpack("createEmptyApp", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
// PackCreateEmptyAppWithIsolatedBilling is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xf6e842d3.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function createEmptyAppWithIsolatedBilling(bytes32 salt) returns(address app)
func (appController *AppController) PackCreateEmptyAppWithIsolatedBilling(salt [32]byte) []byte {
	enc, err := appController.abi.Pack("createEmptyAppWithIsolatedBilling", salt)
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackCreateEmptyAppWithIsolatedBilling is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xf6e842d3.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function createEmptyAppWithIsolatedBilling(bytes32 salt) returns(address app)
func (appController *AppController) TryPackCreateEmptyAppWithIsolatedBilling(salt [32]byte) ([]byte, error) {
	return appController.abi.Pack("createEmptyAppWithIsolatedBilling", salt)
}

// UnpackCreateEmptyAppWithIsolatedBilling is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0xf6e842d3.
//
// Solidity: function createEmptyAppWithIsolatedBilling(bytes32 salt) returns(address app)
func (appController *AppController) UnpackCreateEmptyAppWithIsolatedBilling(data []byte) (common.Address, error) {
	out, err := appController.abi.Unpack("createEmptyAppWithIsolatedBilling", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)

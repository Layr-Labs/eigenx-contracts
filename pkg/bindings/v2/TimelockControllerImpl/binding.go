...
// PackGetPendingOperationIds is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x7b146198.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function getPendingOperationIds() view returns(bytes32[])
func (timelockControllerImpl *TimelockControllerImpl) PackGetPendingOperationIds() []byte {
	enc, err := timelockControllerImpl.abi.Pack("getPendingOperationIds")
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackGetPendingOperationIds is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x7b146198.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function getPendingOperationIds() view returns(bytes32[])
func (timelockControllerImpl *TimelockControllerImpl) TryPackGetPendingOperationIds() ([]byte, error) {
	return timelockControllerImpl.abi.Pack("getPendingOperationIds")
}

// UnpackGetPendingOperationIds is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0x7b146198.
//
// Solidity: function getPendingOperationIds() view returns(bytes32[])
func (timelockControllerImpl *TimelockControllerImpl) UnpackGetPendingOperationIds(data []byte) ([][32]byte, error) {
	out, err := timelockControllerImpl.abi.Unpack("getPendingOperationIds", data)
	if err != nil {
		return *new([][32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([][32]byte)).(*[][32]byte)
...
// PackGetPendingOperations is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x64440ce5.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function getPendingOperations() view returns((bytes32,address,bytes,uint256)[] ops)
func (timelockControllerImpl *TimelockControllerImpl) PackGetPendingOperations() []byte {
	enc, err := timelockControllerImpl.abi.Pack("getPendingOperations")
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackGetPendingOperations is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x64440ce5.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function getPendingOperations() view returns((bytes32,address,bytes,uint256)[] ops)
func (timelockControllerImpl *TimelockControllerImpl) TryPackGetPendingOperations() ([]byte, error) {
	return timelockControllerImpl.abi.Pack("getPendingOperations")
}

// UnpackGetPendingOperations is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0x64440ce5.
//
// Solidity: function getPendingOperations() view returns((bytes32,address,bytes,uint256)[] ops)
func (timelockControllerImpl *TimelockControllerImpl) UnpackGetPendingOperations(data []byte) ([]TimelockControllerImplPendingOp, error) {
	out, err := timelockControllerImpl.abi.Unpack("getPendingOperations", data)
	if err != nil {

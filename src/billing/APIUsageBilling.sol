...
import {IAPIUsageBilling} from "./interfaces/IAPIUsageBilling.sol";

/**
 * @title APIUsageBilling
 * @notice Abstract base contract for API usage-based billing
 * @dev API keys accumulate usage units, billed at end of period.
 *      Extend this contract to add product-specific logic and access control.
 */
abstract contract APIUsageBilling is IAPIUsageBilling {
    ...
    /**
     * @dev Initializes the API usage billing state variables
     * @param _oracle Address of the oracle that reports usage
     */
    function __APIUsageBilling_init(address _oracle) internal {
        oracle = _oracle;
    }

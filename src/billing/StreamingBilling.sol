...
import {IStreamingBilling} from "./interfaces/IStreamingBilling.sol";

/**
 * @title StreamingBilling
 * @notice Abstract base contract for streaming billing with dual rates
 * @dev Resources consume at continuous rates (running vs stopped).
 *      Extend this contract to add product-specific logic and access control.
 */
abstract contract StreamingBilling is IStreamingBilling {
